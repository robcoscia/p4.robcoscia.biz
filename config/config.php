...
# What is the name of this app?
	define('APP_NAME', 'p4_robcoscia_biz');  
...
# Default DB name for this app
	define('DB_NAME', 'robcosci_p4_robcoscia_biz'); 
...
# For extra security, you might want to set different salts than what the core uses
	define('PASSWORD_SALT', '3y9#y*z(Jc&U3bg!RK55W6CWqdTV-(ygp8u2bFGl');
	define('TOKEN_SALT', 'h3-0!LalyUZTyDhxTOidwLeUZeXcV9S&ib!1K_XK');
